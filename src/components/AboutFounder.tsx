      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="neon-border rounded-2xl bg-[#111111] aspect-square max-w-sm mx-auto w-full flex items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#FF2020]/10 to-transparent" />
            <div className="relative z-10 text-center">
              <div className="w-28 h-28 rounded-full bg-[#FF2020]/20 border-2 border-[#FF2020] flex items-center justify-center mx-auto mb-4 text-[#FF2020] font-black text-4xl">V</div>
              <p className="text-white font-bold text-lg">Verdex Team</p>
              <p className="text-[#FF2020] text-sm mt-1">Funnel Systems Architects</p>
            </div>
          </div>
          <div className="space-y-5">
            ...
            <ul className="space-y-2 mt-4">{credentials.map((c,i) => (<li key={i} className="flex items-start gap-3 text-white/70 text-sm"><span className="text-[#FF2020] mt-0.5 flex-shrink-0">◆</span>{c}</li>))}</ul>
          </div>
        </div>
      </div>
    </section>
