    ...
    <section id="story" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <span className="text-[#39FF14] text-xs font-semibold uppercase tracking-widest">A Message From the Founder</span>
        ...
        <div className="neon-border rounded-2xl bg-[#111111] p-8 sm:p-12 space-y-6 text-white/80 text-lg leading-relaxed">
          ...
          <p>You are probably worried about where your next <span className="bg-[#39FF14]/10 text-[#39FF14] px-1 rounded">strategy call</span> will come from. Stressed. Sleeping like a teething two-year-old.</p>
          ...
          <p>Most coaches and agency owners at your level have <strong className="text-white">an audience, an offer, and a track record</strong>. What they do not have is a <span className="text-[#39FF14] font-bold">system</span> that turns their content into booked calls.</p>
          <p>That is why we built <strong className="text-[#39FF14]">The Content Funnel Stack</strong>. The end-to-end system that turns your YouTube presence into a <span className="bg-[#39FF14]/10 text-[#39FF14] px-1 rounded">high-converting call funnel</span>.</p>
          ...
          <div className="border-t border-[#39FF14]/20 pt-6 flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-[#39FF14]/20 border border-[#39FF14]/40 flex items-center justify-center text-[#39FF14] font-black text-xl">V</div>
