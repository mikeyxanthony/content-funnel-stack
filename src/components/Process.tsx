    ...
    <section id="process" className="py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <span className="text-[#39FF14] text-xs font-semibold uppercase tracking-widest">How It Works</span>
          <h2 className="text-3xl sm:text-4xl font-black mt-3 mb-4">From Day 1 to <span className="text-[#39FF14] neon-glow">Fully Operational</span></h2>
          <p className="text-white/50">A clear 4-step process with no guesswork.</p>
        </div>
        <div className="relative">
          <div className="absolute left-8 top-10 bottom-10 w-px bg-[#39FF14]/20 hidden sm:block" />
            ...
            {steps.map((s) => (
              <div key={s.step} className="relative flex gap-6 items-start">
                <div className="flex-shrink-0 w-16 h-16 rounded-full neon-border bg-[#111111] flex items-center justify-center z-10">
                  <span className="text-[#39FF14] font-black text-base">{s.step}</span>
                </div>
                <div className="flex-1 neon-border rounded-xl bg-[#111111] p-6 pt-5">
                  <div className="flex items-start justify-between gap-4 flex-wrap mb-2">
                    ...
                    <span className="text-[#39FF14] text-xs bg-[#39FF14]/10 border border-[#39FF14]/30 px-3 py-1 rounded-full font-semibold flex-shrink-0">{s.duration}</span>
                  </div>
