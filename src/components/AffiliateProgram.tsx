    ...
    <section id="affiliate" className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="border border-white/10 rounded-2xl bg-[#111111]/30 p-8 sm:p-12 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-black mt-3 mb-4 text-white">Know Someone Who Needs This? <span className="text-[#39FF14]">Get Paid.</span></h2>
          ...
          <a href="mailto:info@verdexstudio.com?subject=CFS Affiliate Program" className="inline-block border border-[#39FF14]/30 text-[#39FF14] hover:bg-[#39FF14]/10 px-8 py-3 rounded-xl text-sm font-bold transition-colors">Apply to Become an Affiliate</a>
